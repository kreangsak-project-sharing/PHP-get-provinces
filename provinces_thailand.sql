...
--
-- Database: `register_webdb`
--

-- --------------------------------------------------------

--
-- Table structure for table `th_amphures`
--

CREATE TABLE `th_amphures` (
  `id` int(5) NOT NULL,
...
--
-- Dumping data for table `th_amphures`
--

INSERT INTO `th_amphures` (`id`, `code`, `name_th`, `name_en`, `province_id`) VALUES
...
--
-- Table structure for table `th_geographies`
--
...
--
-- Dumping data for table `th_geographies`
--

INSERT INTO `th_geographies` (`id`, `name`) VALUES
(1, 'ภาคเหนือ'),
(2, 'ภาคกลาง'),
...
--
-- Table structure for table `th_provinces`
--
...
--
-- Dumping data for table `th_provinces`
--
...
--
-- Table structure for table `th_tambons`
--

CREATE TABLE `th_tambons` (
...
--
-- Dumping data for table `th_tambons`
--

INSERT INTO `th_tambons` (`id`, `zip_code`, `name_th`, `name_en`, `amphure_id`) VALUES
...
--
-- Indexes for table `th_amphures`
--
ALTER TABLE `th_amphures`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `th_geographies`
--
ALTER TABLE `th_geographies`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `th_provinces`
--
ALTER TABLE `th_provinces`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `th_tambons`
--
ALTER TABLE `th_tambons`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `th_amphures`
--
ALTER TABLE `th_amphures`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1007;

--
-- AUTO_INCREMENT for table `th_geographies`
--
ALTER TABLE `th_geographies`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `th_provinces`
--
ALTER TABLE `th_provinces`
